package com.ween.fileuploader.oss.minio.util;

import com.ween.fileuploader.oss.minio.config.MinioProperties;
import io.minio.*;
...
public class MinioUtil {
	 ...
	 * 上传文件
	 */
	public FileUploadResponse uploadFile(MultipartFile file, String bucketName,String subFolder) throws Exception {
		// 判断文件是否为空
		...
		String fileName = subFolder+bucketName + "_" + System.currentTimeMillis() + "_" + format.format(new Date()) + "_"
		...
		String urlHost = "/" + bucketName + "/" + fileName;
	...
	public String getObjectURL(String bucketName, String objectName, Integer expires) throws Exception {
		return client.getPresignedObjectUrl(
				GetPresignedObjectUrlArgs.builder().
						...
						bucket(bucketName).
						object(objectName).
						expiry(expires, TimeUnit.HOURS).build());
	}
	...
	public void putObject(String bucketName, String objectName, InputStream stream) throws Exception {
		client.putObject(
				PutObjectArgs.builder().bucket(bucketName).object(objectName).stream(stream, stream.available(), -1)
